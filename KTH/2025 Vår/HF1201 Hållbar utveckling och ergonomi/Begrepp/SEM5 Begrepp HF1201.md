...
Auditiva indikatorer (Definition):: **Ljudsignaler** som används för att **förmedla information** eller **varningar**, viktiga för att de kan uppfattas **oberoende av riktning**
...
Sensorisk informationsbuffert (Definition):: Ett **minne för nuet** som används för att **temporärt lagra information**
...
Beslutsfattande (Definition):: Ett **val** i en **rymd** av **olika möjligheter**, baserat på **tillgänglig information** och med en **viss risk** involverad

Problemlösning (Definition):: Processen att **identifiera** och **åtgärda** ett **problem** genom att använda **tillgänglig information** och **resurser**
...
Användargränssnitt (Definition):: **Gränssnittet** mellan **människa** och **maskin**, där **kommunikation** sker via **visuella**, **audiella** och **haptiska kanaler**

Visuell kommunikation (Definition):: Användning av **visuella element** som **gestaltning**, **färg**, **riktning** och **symboler** för att **underlätta kommunikation**

Hörsel (Definition):: **Förmågan** att **uppfatta ljud** och **använda det** för att **tolka omgivningen**

Känsel (Definition):: **Förmågan** att **uppfatta beröring**, **tryck**, **temperatur** och **smärta** via **huden**

Alfanumerisk information (Definition):: Information presenterad i form av **bokstäver** och **siffror**

Kvalitativa informationsdon (Definition):: **Visuell information** som beskriver **kvalitativa aspekter** av ett **systemtillstånd**

Kunskap i världen (Definition):: **Information** som är **tillgänglig** i den **externa miljön** och kan användas för att **stödja kognitiva processer**
