...
created: 2024-02-01
updated: 2026-05-26
description: "Handlar om att ta fram produkters kostnader."
---
# 2024-02-01 - ME1003 - Lektion
...
Totala kostnader:
$\text{Totala} \text{Kostnader} = \text{Fasta} \text{Kostnader} + \text{Rörliga} \text{Kostnader} * \text{Volym}$
$\text{TK} = \text{FK} + \text{RK} * \text{Volym}$

Nollpunkten:
$\text{Totala} \text{Intäkter} = \text{Totala} \text{Kostnader}$
...
$\text{Täckningsbidrag} = \text{Särintäkter} - \text{Särkostnader}$
$\text{Resultat} = \text{Täckningsbidrag} - \text{Samkostnader}$
